...
<!-- login form -->
    ...
    <input type="text" class="form-control" id="floatingInput" name="email" placeholder="ingrese su correo electronico" required autofocus pattern="[A-Za-z0-9]{8,12}">
    <label for="floatingInput">Ingrese su correo electronico:</label><br>
</div>
    <div class="form-floating">
